...
require_once($site_classes . '/class.wca_html.php');
require_once($site_classes . '/class.spec_functions.php');

require_once($site_dbConnect);

class TestData_header_html extends GenericTable {
    ...
    public function Display_TestDataMain() {
        ...
        switch ($this->GetValue('fkTestData_Type')) {
            ...
            case 57:
                //LO Lock Test
                $html[0] = $this->Display_DataSetNotes();
                $showPlots = true;
                break;
            ...
            case 59:
                ...
                $html[0] .= $finelosweep->DisplayPlots();
                unset($finelosweep);
                break;
            ...
            case 45:
                ...
                $html[0] .= $wca->Display_AmplitudeStability();
                unset($wca);
                break;
            case 44:
                //WCA AM Noise
