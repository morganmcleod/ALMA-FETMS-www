...
class Cryostat_tempsensor extends GenericTable {
    ...
    public function __construct($fkCryostat, $sensor_number, $in_fc) {
        ...
        parent::__construct("Cryostat_tempsensors", $tempsensor_keyId, "keyId", $in_fc, 'fkFacility');
    }
