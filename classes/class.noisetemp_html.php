...
class NoiseTemperature extends TestData_header {
    ...
    public function DisplayPlots() {
        ...
        $html = ["", ""];
        $html[0] = $this->Display_OptimizationNotes();
        ...
        if ($this->GetValue('Band') == 3) {
            $html[1] .= Band3_NT_results($this->GetValue('keyId'));
            $html[1] .= Band3_CCA_NT_results($this->GetValue('keyId'));
        }
        return $html;
    }
    ...
    private function CalculateBand10AvgNT() {
        ...
        foreach ($this->NT_avgData as $thisRow) {
            ...
            if (isset($lastRow)) {
                ...
                $span0 += freqSpanOutOfSpec(
                    $LO0,
                    $LO1,
                    $lastRow['Pol0Sb1TrAvg'],
                    $thisRow['Pol0Sb1TrAvg'],
                    $this->NT_80_spec,
                    $lower,
                    $upper
                );
                $span1 += freqSpanOutOfSpec(
                    $LO0,
                    $LO1,
                    $lastRow['Pol1Sb1TrAvg'],
                    $thisRow['Pol1Sb1TrAvg'],
                    $this->NT_80_spec,
                    $lower,
                    $upper
                );
