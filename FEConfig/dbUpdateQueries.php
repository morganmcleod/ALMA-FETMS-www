...
class dbUpdateQueries
{
    ...
    {
        $update_fetable=mysqli_query($link, "Update Front_Ends SET ESN='$FrontEndArray[cansn]' WHERE
    ...
    {
        $updateFEComponents=mysqli_query($link, "UPDATE FE_Components SET ESN1='$ComponentArray[esn1]',
        ...
        $AddStatLoc=mysqli_query($link, "INSERT INTO FE_StatusLocationAndNotes(fkFEComponents,fkLocationNames,fkStatusType,
